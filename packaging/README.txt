...
QUICK START (Windows)
  1. Double-click  start-mercury.bat
  2. A window opens. Click "+ New Connection" and enter your kdb+ host:port.
  3. Type a q expression and press Ctrl+Enter to run it.

  That's it. (macOS / Linux: run ./start-mercury.sh instead.)

WHAT YOU NEED
  - Java 17 or newer (free): https://adoptium.net/temurin/releases/?version=17
      NOTE: if you downloaded the "mercury-win" version, Java is already
      bundled — just double-click mercury.exe, nothing to install.
  - Google Chrome is recommended (any browser works — it falls back to your
    default browser automatically).
  - A kdb+/q process to connect to. mercury is the client; point it at your
    own q process, e.g. one started with:  q -p 5000

TIPS
  - Run on a different port:        start-mercury.bat 9000
  - Don't auto-open a browser:      set MERCURY_NO_BROWSER=1  (then start)
...
Project & source: https://github.com/CHANGE-ME/mercury
